...
final List<Product> allProducts = [
  ...
  Product(
      id: "L14",
    name: "Secret Garden Sticker Set",
    price: 1300,
  ...
  Product(
    id: "L15",
    name: "Eastern Royalty Pen Collection",
    price: 5000,
