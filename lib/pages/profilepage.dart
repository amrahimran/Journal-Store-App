                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () async {
                            ...
                            await prefs.setBool('isLoggedIn', false); // Set login status to false on logout
                            
                            // Wait for a short moment to ensure the prefs are saved
                            Future.delayed(const Duration(milliseconds: 500), () {
                              Navigator.pushReplacement(
                                context,
                                MaterialPageRoute(builder: (context) => Splashscreen()), // Redirect to splash screen
                              );
                            });
                          },
                          child: const Text(
